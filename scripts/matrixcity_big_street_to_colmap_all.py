...
def arg_parser():
    ...
    parser.add_argument('--input_dir', type=str, default='/data/work2-gcp-europe-west4-a/qimaqi/datasets/MatrixCity/big_city/', help='Input directory')
...
def main():
    ...
    STREET_NAMEs = ["bottom_area", "left_area",  "right_area",  "top_area"
            ]
    pointcloud_path = '/work/qimaqi/datasets/MatrixCity/big_city_pointcloud/point_cloud_ds20/street/Block_all.ply'
    ...
    with open(os.path.join('/data/work2-gcp-europe-west4-a/qimaqi/datasets/MatrixCity/small_city/', VIEW_NAME , "pose",  'block_A', f'transforms_train.json'), "r") as f:
