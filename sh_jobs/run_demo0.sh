...
# iterate CHUNK_NAMES = '0_0' '0_1'  '1_0'  '1_1'
CHUNK_NAMES=('0_0' '0_1')

# submodules/gaussianhierarchy/build/GaussianHierarchyCreator /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/output/trained_chunks/1_0/point_cloud/iteration_30000/point_cloud.ply /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks//camera_calibration/chunks/1_0  /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks//output/trained_chunks/1_0/ /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/output/scaffold/point_cloud/iteration_30000

#  python -u train_post.py -s /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/camera_calibration/chunks/0_0 --model_path /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/output/trained_chunks/0_0 --hierarchy /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/output/trained_chunks/0_0/hierarchy.hier --iterations 15000 --feature_lr 0.0005 --opacity_lr 0.01 --scaling_lr 0.001 --save_iterations -1 -i /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks//camera_calibration/rectified/images --alpha_masks /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks/camera_calibration/rectified/masks --scaffold_file /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks//output/scaffold/point_cloud/iteration_30000 --skybox_locked --bounds_file /data/work2-gcp-europe-west4-a/qimaqi/datasets/small_city_chunks//camera_calibration/chunks/0_0 --port 6012
